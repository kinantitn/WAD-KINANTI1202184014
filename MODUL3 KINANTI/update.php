...
if ($gambar) {
    if (!in_array($ext, $ekstensi)) {
        ...
        if ($ukuran < 1044070) {
            ...
            $query = "UPDATE modul3_crud SET name='$name', deskripsi='$deskripsi',gambar='$gambar', kategori='$kategori', tanggal='$tanggal',mulai='$mulai', berakhir='$berakhir', tempat='$tempat',harga='$harga', benefit='$benefit' WHERE id = $id";
